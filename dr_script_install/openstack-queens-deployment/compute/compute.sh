...
function start_neutron {
        ...
        docker run -d --name ovs-agent --network=host --privileged --user neutron -v $VAR_LOG_DIR/neutron:/var/log/neutron -v /var/lib/neutron:/var/lib/neutron -v /run:/run:shared -v /run/netns:/run/netns:shared -v /run/openvswitch:/run/openvswitch -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NEUTRON_START='START_NEUTRON_OVS_AGENT'   docker-registry:4000/neutron:q
...
docker run -d --name ovs-agent --network=host --restart unless-stopped --privileged --user neutron -v /u01/docker/docker_log/neutron:/var/log/neutron -v /var/lib/neutron:/var/lib/neutron  --mount type=bind,source=/run/netns,target=/run/netns,bind-propagation=shared --mount type=bind,source=/run/openvswitch,target=/run/openvswitch,bind-propagation=shared -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NEUTRON_START='START_NEUTRON_OVS_AGENT' docker-registry:4000/neutron_dpdk:q
...
function finish_neutron {
        ...
        docker rm dhcp-agent
        detailtask "+Create container ovs-agent dhcp-agent metadata-agent\n"
        docker run -d --name ovs-agent --network=host    --restart unless-stopped       --privileged --user neutron -v /var/log/neutron:/var/log/neutron -v /var/lib/neutron:/var/lib/neutron  -v /run/netns:/run/netns:shared -v /run/openvswitch:/run/openvswitch -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NEUTRON_START='START_NEUTRON_OVS_AGENT'   docker-registry:4000/neutron:q
...
docker run -d --name ovs-agent --network=host --restart unless-stopped --privileged --user neutron -v /u01/docker/docker_log/neutron:/var/log/neutron -v /var/lib/neutron:/var/lib/neutron --mount type=bind,source=/run,target=/run --mount type=bind,source=/run/netns,target=/run/netns,bind-propagation=shared --mount type=bind,source=/run/openvswitch,target=/run/openvswitch,bind-propagation=shared -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NEUTRON_START='START_NEUTRON_OVS_AGENT' docker-registry:4000/neutron_dpdk:q
