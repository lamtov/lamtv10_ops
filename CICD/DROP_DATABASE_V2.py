...
- POST: /api/v1/hosts/add_host
	Bổ xung thêm một Host vào danh sách Hosts dùng trong OverCloud
	body: {"management_ip":"172.16.29.195", "ssh_user":"root", "ssh_password":"123456@Epc", "host_name":"controller_02"}
	response:
	 {
	 	"status":"OK"|"Fail",
	 	"data":{
...
- GET: 	/api/v1/hosts
	Lấy ra danh sách host đã được thêm vào OverCloud
	response {.... "data": [<host_id_1>,<host_id_2>,....<host_id_n>]}

- POST: /api/v1/hosts/discover_hosts
	Gửi yêu cầu chạy ansible get thông tin của các Hosts trong OverCloud về Database. Có thể discover tất cả hosts hoặc từng host một.
	body: {"list_host_id":[<host_id_1>,<host_id_2>,...<host_id_n>]}
	response: {
		"status":"OK" | "Fail",
		"data": {
			"list_hosts":[
...
- GET+POST: /api/v1/hosts/<host_id>/historys
...
- GET:  /api/v1/roles
- Get: /api/v1/roles/<role_id>/role_info
...
- GET: /api/v1/configs/specific_configs/validate
