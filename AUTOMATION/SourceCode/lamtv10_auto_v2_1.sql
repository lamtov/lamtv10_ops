...
-- -----------------------------------------------------
-- Table `auto_lamtv10`.`file_config`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `auto_lamtv10`.`file_config` (
...
CREATE INDEX `fk_file_config_nodes1_idx` ON `auto_lamtv10`.`file_config` (`node_id` ASC) ;
...
CREATE  TABLE IF NOT EXISTS `auto_lamtv10`.`changes` (
  ...
  CONSTRAINT `fk_changes_file_config1`
    ...
    REFERENCES `auto_lamtv10`.`file_config` (`file_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `auto_lamtv10`.`update`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `auto_lamtv10`.`update` (
...
CREATE  TABLE IF NOT EXISTS `auto_lamtv10`.`update_change` (
  ...
  CONSTRAINT `fk_update_change_update1`
    ...
    REFERENCES `auto_lamtv10`.`update` (`update_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `auto_lamtv10`.`password`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `auto_lamtv10`.`password` (
...
CREATE INDEX `fk_password_update1_idx` ON `auto_lamtv10`.`password` (`update_id` ASC) ;


-- -----------------------------------------------------
-- Table `auto_lamtv10`.`openstack_config`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `auto_lamtv10`.`openstack_config` (
  ...
  CONSTRAINT `fk_openstack_config_password1`
    ...
    REFERENCES `auto_lamtv10`.`password` (`password_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_openstack_config_update1_idx` ON `auto_lamtv10`.`openstack_config` (`update_id` ASC) ;

CREATE INDEX `fk_openstack_config_password1_idx` ON `auto_lamtv10`.`openstack_config` (`password_id` ASC) ;

CREATE INDEX `fk_openstack_config_file_config1_idx` ON `auto_lamtv10`.`openstack_config` (`file_id` ASC) ;
