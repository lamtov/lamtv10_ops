...
def run_specific_task_using_python(task):
    ...
    runner = Runner('ansible_compute.yml','multinode',{'extra_vars':{'target':target, 'ansible_password':''},'tags':['install','uninstall']},task.task_display_name, True,  None,None,None)
