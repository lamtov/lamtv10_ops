...
UPDATE DB
UPDATE keystone.endpoint SET url="https://os.controller:8080/v1" WHERE url="http://os-controller:8080/v1";
UPDATE keystone.endpoint SET url="https://os.controller:8080/v1/AUTH_%(project_id)s" WHERE url="http://os-controller:8080/v1/AUTH_%(project_id)s";
