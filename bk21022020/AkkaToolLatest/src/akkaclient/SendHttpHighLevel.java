...
public class SendHttpHighLevel {
    ...
    public static void main(String[] args) throws InterruptedException, UnknownHostException {
        ...
        int typeSend = Integer.getInteger("typeSend", 1);
...
//                = ActorMaterializer.create(ActorMaterializerSettings.create(system).withInputBuffer(16, 32), system);
        ...
        System.out.println("initial size " + materializer.settings().initialInputBufferSize() + "  max inpuyst " + materializer.settings().maxInputBufferSize());
