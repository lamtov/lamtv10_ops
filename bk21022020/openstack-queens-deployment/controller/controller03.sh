...
function install_keystone {
	...
	docker run  -d --name ssl_keystone --network=host  -u root -v /apache2:/var/log/apache2 -v /etc/keystone/credential-keys:/etc/keystone/credential-keys -v /etc/keystone/fernet-keys:/etc/keystone/fernet-keys -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime   -e KEYSTONE_START='START_KEYSTONE' docker-registry:4000/ssl_keystone_v3:q
	cp ./open.rc /root/



	docker run -d --name horizon_ssl_v6 --network=host  -u root -v /var/log/docker/apache2:/var/log/apache2 -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e HORIZON_START='START_HORIZON' docker-registry:4000/ssl_horizon_v2:q
...
du	openstack role add --project demo --user demo user
}
...
function install_glance {
	...
	docker run -d --name ssl_glance-api --network=host --restart unless-stopped -v /var/log/glance:/var/log/glance -v /var/lib/glance:/var/lib/glance -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u glance -e GLANCE_START='START_GLANCE_API' docker-registry:4000/ssl_glance_v2:q
	docker run -d --name ssl_glance-registry --network=host --restart unless-stopped -v /var/log/glance:/var/log/glance -v /var/lib/glance:/var/lib/glance -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u glance -e GLANCE_START='START_GLANCE_REGISTRY' docker-registry:4000/ssl_glance_v2:q
...
/etc/ssl/certs/ca-certificates.crt 
	...
	docker run -d --name ssl_nova-consoleauth --network=host --restart unless-stopped --privileged -u nova -v /var/log/nova:/var/log/nova -v /var/lib/nova:/var/lib/nova -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NOVA_START='START_NOVA_CONSOLEAUTH' docker-registry:4000/ssl_nova_v2:q
	docker run -d --name ssl_nova-api --network=host --privileged --restart unless-stopped -u nova -v /var/log//nova:/var/log/nova -v /var/lib/nova:/var/lib/nova -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NOVA_START='START_NOVA_API' docker-registry:4000/ssl_nova_v2:q
	docker run -d --name ssl_nova-scheduler --network=host --restart unless-stopped --privileged -u nova -v /var/log/nova:/var/log/nova -v /var/lib/nova:/var/lib/nova -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NOVA_START='START_NOVA_SCHEDULER' docker-registry:4000/ssl_nova_v2:q
	docker run -d --name ssl_nova-conductor2 --network=host --restart unless-stopped --privileged -u nova -v /var/log/nova:/var/log/nova -v /var/lib/nova:/var/lib/nova -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NOVA_START='START_NOVA_CONDUCTOR' docker-registry:4000/ssl_nova_v2:q
	docker run -d --name ssl_nova-novncproxy --network=host --restart unless-stopped --privileged -u nova -v /var/log/nova:/var/log/nova -v /var/lib/nova:/var/lib/nova -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NOVA_START='START_NOVA_NOVNCPROXY' docker-registry:4000/ssl_nova_v2:q
	docker run -d --name ssl_nova-placement-api --network=host --restart unless-stopped --privileged -u root -v /var/log/apache2:/var/log/apache2 -v /u01/docker/docker_log/nova/:/var/log/nova/ -v /var/lib/nova:/var/lib/nova -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -e NOVA_START='START_NOVA_PLACEMENT_API' docker-registry:4000/ssl_nova_v2:q
