...
function install_glance {
	...
	docker run   --network=host -v $VAR_LOG_DIR/glance:/var/log/glance -v /home/lamtv10/var/lib/glance:/var/lib/glance -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u glance -e GLANCE_START='BOOTSTRAP' docker-registry:4000/glance:q
	
	detailtask "+Create Glance container\n"
	docker run -d --name glance-api_bk --network=host --restart unless-stopped -v /u01/docker/docker_log/glance:/var/log/glance -v /home/lamtv10/var/lib/glance:/var/lib/glance -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u glance -e GLANCE_START='START_GLANCE_API' docker-registry:4000/glance_v2:q
	docker run -d --name glance-registry_bk --network=host --restart unless-stopped  -v /u01/docker/docker_log/glance:/var/log/glance -v /home/lamtv10/var/lib/glance:/var/lib/glance -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u glance -e GLANCE_START='START_GLANCE_REGISTRY' docker-registry:4000/glance_v2:q
...
#https://docs.openstack.org/swift/pike/install/index.html
...
docker run --network=host --privileged -v /u01/docker/docker_log/swift:/var/log/swift   -v /etc/swift/:/etc/swift/ -v /var/lib/swift:/var/lib/swift -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u root  -e SWIFT_START='SWIFT_BOOTSTRAP' docker-registry:4000/swift_proxy_v6:q
	...
	docker run --network=host --privileged -v /u01/docker/docker_log/swift:/var/log/swift  -v /etc/swift/:/etc/swift/  -v /var/lib/swift:/var/lib/swift -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u root  -e SWIFT_START='SWIFT_INITIAL_ACCOUNT_RINGS' -e  STORAGE_NODE_MANAGEMENT_INTERFACE_IP_ADDRESS=172.16.30.193   -e         DEVICE_NAME=sdc   -e  DEVICE_WEIGHT=100 docker-registry:4000/swift_proxy_v6:q
	docker run --network=host --privileged -v /u01/docker/docker_log/swift:/var/log/swift  -v /etc/swift/:/etc/swift/ -v /var/lib/swift:/var/lib/swift -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u root -e SWIFT_START='SWIFT_INITIAL_CONTAINER_RINGS'  -e  STORAGE_NODE_MANAGEMENT_INTERFACE_IP_ADDRESS=172.16.30.193   -e         DEVICE_NAME=sdc   -e  DEVICE_WEIGHT=100 docker-registry:4000/swift_proxy_v6:q
	docker run --network=host --privileged -v /u01/docker/docker_log/swift:/var/log/swift  -v /etc/swift/:/etc/swift/ -v /var/lib/swift:/var/lib/swift -v /usr/share/docker/:/usr/share/docker/ -v /etc/localtime:/etc/localtime -u root -e SWIFT_START='SWIFT_INITIAL_OBJECT_RINGS'  -e  STORAGE_NODE_MANAGEMENT_INTERFACE_IP_ADDRESS=172.16.30.193   -e         DEVICE_NAME=sdc   -e  DEVICE_WEIGHT=100 docker-registry:4000/swift_proxy_v6:q
	...
	docker run --network=host --privileged -v /u01/docker/docker_log/swift:/var/log/swift -v /var/lib/swift:/var/lib/swift -v /usr/share/docker/:/usr/share/docker/  -v /etc/swift/:/etc/swift/ -v /etc/localtime:/etc/localtime -u swift -e SWIFT_START='SWIFT_VERIFY' docker-registry:4000/swift_proxy_v6:q
