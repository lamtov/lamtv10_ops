...
instances_uuid=connection.execute(db.select([nova_instances.columns.uuid]).where(nova_instances.columns.vm_state=="active" and nova_instances.columns.display_name==instance_name  )).fetchall()[:]
