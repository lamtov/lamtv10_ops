...
ssh -L  172.16.30.82:5672:172.16.31.239:5672 root@172.16.30.82
ssh -L 172.16.32.82:80:172.16.30.89:80 root@172.16.30.82
...
3. java -jar -Dspring.conf.location=file:nse.properties network-slicing-engine-1.2.1-SNAPSHOT_X.jar
...

{
   "name":"pop-3",
   "authUrl":"http://172.16.31.239:5000/v3",
   "tenant":"0171c410083d4b8d96969b6735e3f75a",
   "username":"admin",
   "password":"Vttek@123",
   "securityGroups":[
      "default"
...
neutron qos-bandwidth-limit-rule-create BRONZE --max-kbps 8192 --max-burst-kbps 6553


openstack network qos rule show bw-limiter e6277bbf-8e75-4e1d-9bd6-5b0f94552575
...
SET GLOBAL pxc_strict_mode=PERMISSIVE;
       ...
       - bandwidth_limit:INGRESS_BRONZE
