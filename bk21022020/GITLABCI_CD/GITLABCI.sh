...
grep "^[^#;]"  /home/srv/gitlab/config/gitlab.rb


git clone ssh://git@172.16.29.193:2222/lamtv10/software_deployment.git 
git clone ssh://git@172.16.29.193:2222/mailp/testapi.git
git clone ssh://git@172.16.29.193:2222/lamtv10/project3.git
git clone ssh://git@172.16.29.193:2222/lamtv10/project1.git
git clone ssh://git@172.16.29.193:2222/lamtv10/project1fsdfsdfs.git
git clone ssh://git@172.16.29.193:2222/lamtv10/af.git
git clone ssh://git@172.16.29.193:2222/lamtv10/project5.git
git clone ssh://git@172.16.29.193:2222/lamtv10/project2.git