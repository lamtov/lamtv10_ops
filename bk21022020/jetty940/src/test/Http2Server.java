...
public class Http2Server {
    ...
    public static void main(String... args) throws Exception {
        ...
        int port = Integer.getInteger("port", 8443);
        ...
        sslContextFactory.setKeyStoreResource(Resource.newClassPathResource("/resources/keystore.p12"));

        System.out.println("resource: " + Resource.newClassPathResource("/resources/keystore.p12"));
