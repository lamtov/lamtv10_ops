...
public class Http2Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        client.setMaxConcurrentPushedStreams(10000);
        SslContextFactory sslContextFactory = new SslContextFactory(true);
        client.addBean(sslContextFactory);
        client.start();

        // Connect to host.
        String host = "172.16.29.198";
        int port = 8443;
        ...
        for (int i = 0; i < 100000; i++) {
            sendData(host, port, client, session,i);
        }
    ...
    public static void sendData(String host, int port, HTTP2Client client, Session session,int i) throws InterruptedException, ExecutionException, TimeoutException {
...
//                    if (advanced || lastContent) {
                ByteBuffer content = ByteBuffer.wrap(("tovanlam"+i).getBytes());
