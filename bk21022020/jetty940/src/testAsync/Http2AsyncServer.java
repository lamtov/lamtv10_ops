...
public class Http2AsyncServer {
    ...
    public static void main(String... args) throws Exception {
        ...
        //sssServletContextHandler context = new ServletContextHandler(server, "/", ServletContextHandler.SESSIONS);
        //context.addServlet(new ServletHolder(new Servlet()), "/");

        ServletHolder asyncHolder = context.addServlet(AsyncEchoServlet.class, "/");
